...
function Reportsorders(req,res){
	...
	this.earnings	=	(req,res,next)=>{
		if(isPost(req)){
			...
			let commonCondition	= {is_deleted : NOT_DELETED,order_status:{$in:[API_ORDER_DELIVERED,API_ORDER_RATED]}};
			...
			req.breadcrumbs(BREADCRUMBS['admin/reports_statistics/earnings']);
			res.render('list',{
				userCount 			: NOT,
				monthYearWiseData   : {}
			});
